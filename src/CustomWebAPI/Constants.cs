...
namespace CustomWebAPI
{
    class Constants
    {
        ...
        public class ConfigServices
        {
            ...
            public const string LogPath = "LOGS_PATH";
            public const string IsInputMessage = "IS_INPUT_MESSAGE";
            public const string IsOutputMessage = "IS_OUTPUT_MESSAGE";
            public const string IsErrorMessage = "IS_ERROR_MESSAGE";
            public const string PathXSDSchemas = "PATH_XSD_SCHEMAS";
        }
        ...
        {
            public const string EDocumentID = "EDocumentID";
            public const string RequisiteName = "RequisiteName";
